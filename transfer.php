...
<head>
  ...
  <title>Sparks Bank - Service</title>
    ...
    while($rows=mysqli_fetch_assoc($result)){
      ?>
              <tr>
                        ...
                        <td class="text-center"><a href="./Send.php?id= <?php echo $rows['id'] ;?>"><button type="button" class="btn btn-info ">Show Details</button></a></td>
                      </tr>
                <?php
                    }
                ?>
